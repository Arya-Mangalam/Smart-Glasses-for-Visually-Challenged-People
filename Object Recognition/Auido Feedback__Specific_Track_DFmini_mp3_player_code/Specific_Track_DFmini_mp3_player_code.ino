//Run this code on arduino ide to get a audio feedback. Use memory card and load person and object track to get feedback.
...
void loop()
{
  ...
  while (Serial.available() > 0)
  {
     ...
     if ((command >= '1') && (command <= '9'))
    {
      ...
      delayLoop();//for delayed Serial input optional
      menu_opcoes();
    }
